...
export const metadata: Metadata = {
  title: "Alpine Luxury Hotel Switzerland | Premium Alpine Hospitality",
  description: "Discover luxury alpine hospitality in Switzerland. Exclusive suites, Michelin-inspired dining, spa wellness, and award-winning service in the heart of the Swiss Alps.",
  keywords: "luxury hotel Switzerland, alpine resort, Swiss hospitality, mountain hotel, luxury accommodations",
  openGraph: {
    title: "Alpine Luxury Hotel | Premium Swiss Alpine Resort",
    description: "Experience timeless elegance in the heart of Switzerland. Award-winning luxury hotel with stunning mountain views, fine dining, and world-class amenities.",
    url: "https://alpineluxury.ch",
    siteName: "Alpine Luxury Hotel",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764063847639-otklzo13.jpg",
        alt: "Alpine Luxury Hotel - Swiss Alps"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Alpine Luxury Hotel | Swiss Alps",
    description: "Discover premium luxury hospitality in Switzerland. Exclusive rooms, fine dining, spa & wellness.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764063847639-otklzo13.jpg"]
  },
  robots: {
    index: true,
    follow: true
